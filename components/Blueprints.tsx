    ...
    <section id="docs" className="py-24 relative bg-transparent overflow-hidden border-t border-slate-800/50 z-10">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="relative group cursor-pointer transition-transform duration-300 hover:-translate-y-1">
          ...
          <div className="relative px-8 py-12 bg-surface-dark/70 ring-1 ring-slate-800/80 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-8 backdrop-blur-md">
            ...
            <div className="md:w-1/3 flex justify-end">
              <a href="#" className="flex items-center justify-center w-full md:w-auto px-6 py-3 border-2 border-purple-500 text-purple-400 font-bold uppercase tracking-wider rounded-lg hover:bg-purple-900/20 transition-colors">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div className="p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-purple-500/30 transition-colors backdrop-blur-sm">
          ...
          <div className="p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-purple-500/30 transition-colors backdrop-blur-sm">
            <span className="block text-3xl font-bold text-white mb-1">50ms</span>
            <span className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Latency</span>
          </div>
          <div className="p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-purple-500/30 transition-colors backdrop-blur-sm">
            <span className="block text-3xl font-bold text-white mb-1">v2.1</span>
            <span className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Current</span>
          </div>
          <div className="p-6 rounded-xl bg-slate-900/40 border border-slate-800/80 hover:border-purple-500/30 transition-colors backdrop-blur-sm">
            <span className="block text-3xl font-bold text-white mb-1">10k+</span>
            <span className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Users</span>
          </div>
        </div>
      </div>
    </section>
